<template>
    ...
    <div class="w-7/12 h-7/12">
        <br>
    <br>
        <h1>Les différents types d'accompagnement</h1>
        <p>
            - Vision intégrale et intégrative de la santé <br>
            - Vers une perception de soi et des autres élargie <br>
            -                                            <br>
        </p>
        <br>
    <br>
    ...
    <br>
    <br>
    <h1 class="text-center">Vision intégrale et intégrative de la santé</h1>
    <br>
    <br>
    <br>
